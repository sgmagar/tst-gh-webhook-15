"""
Django settings for tst_gh_webhook_15 project.
...
ROOT_URLCONF = 'tst_gh_webhook_15.urls'
...
WSGI_APPLICATION = 'tst_gh_webhook_15.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_gh_webhook_15 API",
    "DESCRIPTION": "API documentation for tst_gh_webhook_15 App",
    "VERSION": "v1",
}
